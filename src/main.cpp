...
int64 nChainStartTime = 1460946510;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The Times 18/Apr/2016 Chancellor on brink of second bailout for banks";
        CTransaction txNew;
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("afd8f1b012041f20a5bda3708a1abfcb43341ce7ebf694cdbe36de7c83718efb"));
